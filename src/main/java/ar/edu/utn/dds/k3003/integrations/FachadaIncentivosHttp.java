...
public class FachadaIncentivosHttp implements FachadaIncentivos {

  private final RestClient restClient;

  public FachadaIncentivosHttp(String baseUrl) {
    this.restClient = RestClient.builder().baseUrl(baseUrl).build();
  }

  @Override
  public void procesarDonador(String donadorID) throws NoSuchElementException {
    restClient.post().uri("/procesamiento/{id}", donadorID).retrieve().toBodilessEntity();
  }
